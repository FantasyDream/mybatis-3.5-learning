...
public class ResultMap {
  ...
  /**
   * 记录了映射关系中带有ID标志的映射关系,例如<id><constructor><idArg>节点
   */
  private List<ResultMapping> idResultMappings;
  /**
   * 记录了映射关系中歹有constructor标志的映射关系,例如<constructor>所有子元素
   */
  ...
  /**
   * 是否含有嵌套的结果映射, 如果某个映射关系中存在resultMap属性,却不存在resultSet属性,则为true
   */
